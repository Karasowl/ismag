...
export const meta = ({ data, location }) => {
  ...
  const url = new URL("/musica", site).toString();
  const title = "Música de Ismael Guimarais | Canciones y lanzamientos";
  const description = "Escucha la música de Ismael Guimarais. Canciones reflexivas sobre fe, propósito y esperanza. Disponible en Spotify, Apple Music, YouTube Music y más.";
  ...
  return [
    ...
    { tagName: "link", rel: "canonical", href: url },
    {
      "script:ld+json": {
        ...
        "@type": "MusicPlaylist",
        "name": "Música de Ismael Guimarais",
  ...
  return (
    <main className="section">
      ...
      <div className="card" style={{ marginTop: 'var(--space-8)' }}>
        <h2 style={{ fontSize: 'var(--text-2xl)', marginBottom: 'var(--space-6)' }}>Escúchame en todas las plataformas</h2>
        ...
        <div className="music-platforms-grid">
          ...
          >
            ...
            <span>Ver videoclip en YouTube</span>
          </a>
        </div>
      </div>
      ...
      <div className="card" style={{ marginTop: 'var(--space-8)' }}>
        ...
        <a className="button button--primary" href="/newsletter/confirmacion" style={{ marginTop: 'var(--space-4)' }}>
